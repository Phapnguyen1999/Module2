package vn.nqp.shop.utils;

import vn.nqp.shop.views.InputOption;
import vn.nqp.shop.views.LoginView;
        ...
        do {
            switch (inputOption) {
                ...
                case UPDATE:
                    ...
                    break;
                case DELETE:
                    System.out.println("Nhấn 'y' để xoá tiếp \t|\t 'q' để quay lại\t|\t 't' để thoát chương trình");
                    break;
                case SHOW:
